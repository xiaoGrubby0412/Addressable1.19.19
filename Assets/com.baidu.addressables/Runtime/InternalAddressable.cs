...
namespace UnityEngine.AddressableAssets
{
    public static class InternalAddressable
    {
        ...
        {
            return m_AddressablesInternal.UnloadSceneAsync(scene, UnloadSceneOptions.None, autoReleaseHandle);
        }
        ...
        {
            return m_AddressablesInternal.UnloadSceneAsync(handle, UnloadSceneOptions.None, autoReleaseHandle);
        }
